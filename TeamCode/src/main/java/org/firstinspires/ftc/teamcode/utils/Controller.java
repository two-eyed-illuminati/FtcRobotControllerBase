...
public class Controller {
    ...
    public Controller(double pCoefficient, double dCoefficient, double feedforwardCoefficient){
    ...
    public double getPower(double currPos, double targetPos){
        double power = feedforwardCoefficient * targetPos +
                pCoefficient * (targetPos-currPos) +
                dCoefficient * (targetPos-currPos - oldError) / timeSinceOld.seconds();
